...
def get_updt_input(dtls):
    ...
    year = get_valid_updt_input(f"Old Year {old_year} :: Enter New Year : ",validate_year,int,old_year)
    print("")       
    section = get_valid_updt_input(f"Old Section {old_section} :: Enter New Section : ",validate_section,str,old_section)
    print("")
    father_name = get_valid_updt_input(f"Old Father Name {old_father_name} :: Enter New Father Name : ",validate_name,str,old_father_name)
    print("")
    mother_name =get_valid_updt_input(f"Old Mother Name {old_mother_name} :: Enter New Mother Name : ",validate_name,str,old_mother_name)
    print("")
    parent_phone = get_valid_updt_input(f"Old Parents Ph.No {old_parent_phone} :: Enter New Parents Ph.No : ",validate_phone,str,old_parent_phone)
    print("")
    email = get_valid_updt_input(f"Old Email {old_email} :: Enter New Email : ",validate_email,str,old_email)
    print("")
    
    python_marks = get_valid_updt_input(f"Old Python Mark {old_python_marks} :: Enter New Python Mark : ",validate_marks,float,old_python_marks)
    print("")
    math_marks = get_valid_updt_input(f"Old Math Mark {old_math_marks} :: Enter New Math Mark : ",validate_marks,float,old_math_marks)
    print("")
    english_marks = get_valid_updt_input(f"Old English Mark {old_english_marks} :: Enter New English Mark : ",validate_marks,float,old_english_marks)
    print("")
